...
print(f"Candidato1 = {ct_candidato1} votos.")
print(f"Candidato2 = {ct_candidato2} votos.")
print(f"Candidato3 = {ct_candidato3} votos.")
print(f"Votos nulos = {ct_nulo}")
print(f"Votos em branco = {ct_branco}")
""" --- ALTERAÇÕES:
